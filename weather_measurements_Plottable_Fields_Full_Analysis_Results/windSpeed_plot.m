% MATLAB script for plotting field: windSpeed
hist_data = load('windSpeed_histogram.txt');
bin_centers = (hist_data(:,1) + hist_data(:,2))/2;
counts = hist_data(:,3);
f5 = figure('Name', 'windSpeed Histogram');
...
A = fileread('windSpeed_full_analysis.txt');
